...
public class FXMainPane extends VBox {
	...
	FXMainPane() {
		...
		// ADDING IMAGE
		Image image = new Image("file:import.PNG");
		...
		//addTownVBox.getChildren().addAll(iv);
		//addTownVBox.getChildren().addAll(addTownLabel, addTownHBox);
		...
		displayRoadVBox.setPrefWidth(200);
		          //displayRoadVBox.getChildren().addAll(iv, displayRoads, displayRoadsButton);
		...
		VBox box = new VBox(iv);
		          //addRoad.getChildren().addAll(box, addRoadVBox, displayRoadVBox);
		          addRoad.getChildren().addAll(box);
	    ...
	    findConnectionLabel = new Label("Find Shortest Route");
		...
		findConnectionButton = new Button("Find Shortest Route");
	...
	public void readFile() {
		...
		*/
		...
		File selectedFile = new File("US Towns.txt");
		try {
			if(selectedFile != null) {
				graph.populateTownGraph(selectedFile);
				}
